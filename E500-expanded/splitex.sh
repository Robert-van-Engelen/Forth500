...
bin2wav --pc=E500 --type=bin --addr=0xB0000 --sync=9 Forth500-1.bin
bin2wav --pc=E500 --type=bin --addr=0xB1800 --sync=9 Forth500-2.bin
bin2wav --pc=E500 --type=bin --addr=0xB3000 --sync=9 Forth500-3.bin
